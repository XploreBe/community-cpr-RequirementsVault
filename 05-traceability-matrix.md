...
**Last updated:** 2026-07-13 (CHG-003 through CHG-017; Phase 2 backlog + specs added, then rescoped, then remaining open questions/assumption resolved)
...
| REQ-F-008 | Tiered order — certified/healthcare-professional first | — | Phase 2 [CHG-003 — OQ-001 resolved; CHG-010 — AS-001 resolved] | EPIC-5 | US-206 (Ready [CHG-010]) | [[04-speckit-specs/epic5-us206-tiered-notification-order\|Spec]] |
...
| REQ-F-017 | Track certification expiry | — | **Phase 3** [CHG-009 — deferred] | EPIC-6 | US-211 (consequence resolved [CHG-017]: excluded from new alerts until re-verified, no auto-demotion) | [[04-speckit-specs/epic6-us211-track-certification-expiry\|Spec]] |
...
| REQ-N-006 | Encryption "everywhere" | Security | **Phase 3** [CHG-009 — deferred] — cross-cutting constraint on US-201 (login) and all data flows; OQ-010 resolved (CHG-016) — minimum TLS in transit + at-rest for sensitive fields via datastore defaults, no key-mgmt scheme mandated |
...
| REQ-N-010 | Patient location retention limit | Privacy | Phase 2 — US-209 (rule/constraint). OQ-009 resolved (CHG-012) — 90-day placeholder, pending real legal review per jurisdiction |
...
| REQ-N-017 | Sub-second nearby-volunteer search | Performance | Phase 2 — US-204 (rule/constraint). OQ-003 resolved (CHG-006, delegated to dev); OQ-007 resolved (CHG-011) — flat "under 1 second," no benchmark methodology |
| REQ-N-018 | Battery-friendly background location | Performance/Usability | **Phase 3** [CHG-009 — deferred] — US-214 (rule/constraint). OQ-008 resolved (CHG-015) — no concrete number, dev discretion |
...
| — | US-206 | REQ-F-008, REQ-F-032 — Ready [CHG-010, AS-001 resolved] | [[04-speckit-specs/epic5-us206-tiered-notification-order\|Spec]] |
...
| — | US-211 (Phase 3, deferred [CHG-009]) | REQ-F-017 — consequence resolved [CHG-017]: excluded from new alerts until re-verified, no auto-demotion | [[04-speckit-specs/epic6-us211-track-certification-expiry\|Spec]] |
...
| OQ-007 | Precise "sub-second" definition | **Resolved — CHG-011.** Kept simple: flat "under 1 second," no concurrency/region/volunteer-count benchmark. REQ-N-017, US-204 (Phase 2) unblocked. |
| OQ-008 | Precise "battery-friendly" definition | **Resolved — CHG-015.** No concrete number — "reasonable battery use, no aggressive constant GPS polling," dev discretion. REQ-N-018, US-214 (Phase 3, deferred [CHG-009]). |
| OQ-009 | Patient location retention period | **Resolved — CHG-012.** 90 days, placeholder value pending real legal review per deployment jurisdiction (test project, easy to change later). REQ-N-010, US-209 (Phase 2) unblocked. |
| OQ-010 | Scope of "encryption everywhere" | **Resolved — CHG-016.** Minimum HTTPS/TLS in transit everywhere, plus at-rest encryption for sensitive fields via the chosen datastore's defaults; no key-management scheme mandated. REQ-N-006, US-201 (Phase 3, deferred [CHG-009]). |
...
| OQ-012 | Offline/connectivity handling for alerts | **Resolved — CHG-013.** Offline/no-signal/force-closed counts as "not reached" — no retry/queueing, widening proceeds as if ignored. REQ-F-021, REQ-N-001, US-216 (Phase 2). |
| OQ-013 | Can a volunteer back out after accepting? | **Resolved — CHG-014.** No — once accepted, accepted, no back-out flow. REQ-F-024, REQ-F-010, US-208, US-103 (Phase 2/Phase 1). |
| OQ-014 | Certification-expiry consequence; mid-incident volunteer deactivation | **Resolved — CHG-017.** Expired certification excludes the volunteer from new alerts until re-verified, no auto-demotion; an in-flight incident is never interrupted regardless of certification/deactivation change. REQ-F-017, REQ-F-018, REQ-F-035, US-211, US-222 (Phase 3, deferred [CHG-009]). |
