...
**Date:** 2026-07-06
**Status:** Draft — Phase 1 and Phase 2 both have stories and specs now. Phase 2 uses no repo tag (one consolidated repo) and no enablers/spikes, per the team's move to spec-driven development.
**Last updated:** 2026-07-13 (CHG-003 through CHG-008; Phase 2 backlog + specs added)

## 1. Functional Requirements → Story → Spec

| REQ-F | Short description | Repo | Phase | Epic | Story | Spec |
|-------|--------------------|------|-------|------|-------|------|
| REQ-F-001 | Login with dispatcher/admin roles [CHG-005 — simplified from dispatcher/supervisor/admin] | — | Phase 2 | EPIC-4 | US-201, US-203 | [[04-speckit-specs/epic4-us201-login-with-role-based-access\|Spec]], [[04-speckit-specs/epic4-us203-admin-cross-incident-oversight\|Spec]] |
...
| REQ-F-016 | Upload certification | — | Phase 2 | EPIC-6 | US-210 | [[04-speckit-specs/epic6-us210-upload-certification\|Spec]] |
| REQ-F-017 | Track certification expiry | — | Phase 2 | EPIC-6 | US-211 (Ready, conditional — consequence of expiry rests on OQ-014, open) | [[04-speckit-specs/epic6-us211-track-certification-expiry\|Spec]] |
| REQ-F-018 | Remind to re-verify certification | — | Phase 2 | EPIC-6 | US-212 | [[04-speckit-specs/epic6-us212-remind-reverify-certification\|Spec]] |
...
| REQ-F-020 | Background location collection with consent | — | Phase 2 | EPIC-6 | US-214 | [[04-speckit-specs/epic6-us214-consent-background-location\|Spec]] |
...
| REQ-F-022 | Push bypasses silent/DND where allowed | — | Phase 2 (OQ-004 resolved — CHG-007; best-effort, no mandated mechanism) | EPIC-7 | US-217 | [[04-speckit-specs/epic7-us217-push-dnd-bypass\|Spec]] |
| REQ-F-023 | Explicit consent record | — | Phase 2 | EPIC-6 | US-214 | [[04-speckit-specs/epic6-us214-consent-background-location\|Spec]] |
...
| REQ-F-032 | Backend tiered alert logic, per-country configurable | — | Phase 2 (OQ-001 resolved — CHG-003; OQ-005 resolved — CHG-008) | EPIC-5 / EPIC-8 | US-206, US-221 | [[04-speckit-specs/epic5-us206-tiered-notification-order\|Spec]], [[04-speckit-specs/epic8-us221-configure-country-alerting-rules\|Spec]] |
...
| REQ-F-035 | Volunteer registry (tier, cert, status, history) | backend-api / — | Phase 1 (partial — read-only, no history) + Phase 2 (full) | EPIC-3 (Phase 1) / EPIC-6 (Phase 2) | ENABLER-003 (Phase 1); US-215 (Phase 2 full) | [[04-speckit-specs/epic3-enabler003-volunteer-read-endpoint\|Spec]], [[04-speckit-specs/epic6-us215-volunteer-status-history\|Spec]] |
| REQ-F-036 | Data partitioned per country/jurisdiction | backend-api / — | Phase 1 (datastore shaped for it, not enforced) + Phase 2 (enforced) | EPIC-3 (Phase 1) / EPIC-8 (Phase 2) | ENABLER-002 (Phase 1); US-219 (Phase 2 enforced) | [[04-speckit-specs/epic3-enabler002-incident-crud-endpoints\|Spec]], [[04-speckit-specs/epic8-us219-country-scoped-data-visibility\|Spec]] |
| REQ-F-037 | Admin tools — manage volunteers | — | Phase 2 | EPIC-8 | US-222 | [[04-speckit-specs/epic8-us222-admin-manage-volunteers\|Spec]] |
| REQ-F-038 | Admin tools — verify certifications | — | Phase 2 | EPIC-8 | US-223 | [[04-speckit-specs/epic8-us223-admin-verify-certifications\|Spec]] |
| REQ-F-039 | Admin tools — manage in-app content | — | Phase 2 | EPIC-8 | US-224 | [[04-speckit-specs/epic8-us224-admin-manage-reference-content\|Spec]] |
...
| REQ-N-003 | Graceful degradation if a dependency fails | Reliability | Phase 2 — cross-cutting constraint on EPIC-5 and EPIC-7 |
| REQ-N-004 | Multi-country deployment without re-platforming | Scalability | Phase 2 — US-219, US-220. OQ-005 resolved (CHG-008, delegated to dev) |
| REQ-N-005 | MFA for dispatchers | Security | Phase 2 — US-202, paired with REQ-F-001/US-201 (OQ-011 resolved — CHG-005) |
| REQ-N-006 | Encryption "everywhere" | Security | Phase 2 — cross-cutting constraint on US-201 (login) and all data flows; depends on OQ-010 |
| REQ-N-007 | Least-privilege access control | Security | Phase 2 — covered directly in US-201, US-203 acceptance criteria |
| REQ-N-008 | Security audit logging | Security | Phase 2 — cross-cutting constraint on EPIC-4 and all admin/security actions (US-222, US-223) |
| REQ-N-009 | Data minimisation | Privacy | Phase 2 — cross-cutting constraint on US-214 (consent) and US-210 (upload) |
| REQ-N-010 | Patient location retention limit | Privacy | Phase 2 — US-209 (rule/constraint), depends on OQ-009 |
| REQ-N-011 | Volunteer location only while active/opt-in | Privacy | Phase 2 — US-214, paired with REQ-F-020 |
| REQ-N-012 | Language configurable per country | Portability | Phase 2 — US-220. OQ-005 resolved (CHG-008, delegated to dev) |
| REQ-N-013 | Address format configurable per country | Portability | Phase 2 — US-220. OQ-005 resolved (CHG-008, delegated to dev) |
| REQ-N-014 | Emergency number configurable per country | Portability | Phase 2 — US-220. OQ-005 resolved (CHG-008, delegated to dev) |
| REQ-N-015 | Units configurable per country | Portability | Phase 2 — US-220. OQ-005 resolved (CHG-008, delegated to dev) |
| REQ-N-016 | Country-specific business rules configurable | Portability | Phase 2 — US-221. OQ-005 resolved (CHG-008, delegated to dev) |
...
| REQ-N-018 | Battery-friendly background location | Performance/Usability | Phase 2 — US-214 (rule/constraint), depends on OQ-008 |
...
| — | US-201 | REQ-F-001, REQ-N-007 | [[04-speckit-specs/epic4-us201-login-with-role-based-access\|Spec]] |
| — | US-202 | REQ-N-005 | [[04-speckit-specs/epic4-us202-complete-mfa-at-login\|Spec]] |
| — | US-203 | REQ-F-001 | [[04-speckit-specs/epic4-us203-admin-cross-incident-oversight\|Spec]] |
...
| — | US-210 | REQ-F-016 | [[04-speckit-specs/epic6-us210-upload-certification\|Spec]] |
| — | US-211 | REQ-F-017 — Ready (conditional, tracking/flagging only; consequence behaviour rests on OQ-014, open) | [[04-speckit-specs/epic6-us211-track-certification-expiry\|Spec]] |
| — | US-212 | REQ-F-018 | [[04-speckit-specs/epic6-us212-remind-reverify-certification\|Spec]] |
| — | US-213 | REQ-F-019 | [[04-speckit-specs/epic6-us213-set-availability\|Spec]] |
| — | US-214 | REQ-F-020, REQ-F-023, REQ-N-011 | [[04-speckit-specs/epic6-us214-consent-background-location\|Spec]] |
| — | US-215 | REQ-F-035 (full) | [[04-speckit-specs/epic6-us215-volunteer-status-history\|Spec]] |
| — | US-216 | REQ-F-021 (full), REQ-F-033, REQ-N-001 | [[04-speckit-specs/epic7-us216-receive-real-push-alert\|Spec]] |
| — | US-217 | REQ-F-022 | [[04-speckit-specs/epic7-us217-push-dnd-bypass\|Spec]] |
| — | US-218 | REQ-F-034 | [[04-speckit-specs/epic7-us218-track-push-delivery-status\|Spec]] |
| — | US-219 | REQ-F-036, REQ-N-004 | [[04-speckit-specs/epic8-us219-country-scoped-data-visibility\|Spec]] |
| — | US-220 | REQ-N-012, REQ-N-013, REQ-N-014, REQ-N-015 | [[04-speckit-specs/epic8-us220-configure-country-settings\|Spec]] |
| — | US-221 | REQ-N-016, REQ-F-032 | [[04-speckit-specs/epic8-us221-configure-country-alerting-rules\|Spec]] |
| — | US-222 | REQ-F-037 | [[04-speckit-specs/epic8-us222-admin-manage-volunteers\|Spec]] |
| — | US-223 | REQ-F-038 | [[04-speckit-specs/epic8-us223-admin-verify-certifications\|Spec]] |
| — | US-224 | REQ-F-039 | [[04-speckit-specs/epic8-us224-admin-manage-reference-content\|Spec]] |
