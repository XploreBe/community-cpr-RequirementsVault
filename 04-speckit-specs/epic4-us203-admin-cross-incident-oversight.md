...
**Status:** Deferred to Phase 3 [CHG-009, 2026-07-13] — not part of the current Phase 2 round. Kept as-is, ready to pick up once login/roles (US-201) is prioritized.
