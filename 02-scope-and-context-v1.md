...
| REQ-F-001, REQ-N-005 (login/roles/MFA) | Must | M | Laag | OQ-011 resolved [CHG-005] — two roles (dispatcher, admin), permission boundaries now defined; standard well-understood pattern. |
| REQ-F-006, 031, REQ-N-017 (radius search, nearby-volunteer search, sub-second target) | Must | L | Medium | Geospatial DB/indexing choice delegated to dev team (OQ-003 resolved [CHG-006]); performance target itself is still not precisely defined (OQ-007 — open). |
...
| REQ-F-036, REQ-N-004, REQ-N-012..016 (country partitioning + full portability config) | Must | L | Medium | Country-abstraction technical approach delegated to dev team (OQ-005 resolved [CHG-008]); still touches almost every module. |
...
- All other open questions carried from 01-requirements-structured-v1.md (OQ-002, OQ-007, OQ-008, OQ-009, OQ-010, OQ-012, OQ-013, OQ-014, OQ-015) affect Phase 2 or later items only and do not block Phase 1 as scoped above; none of these six resolutions touch them.
